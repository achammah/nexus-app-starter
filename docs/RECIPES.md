...
```json
"pages": [
  { "key": "warroom",  "label": "War Room",  "icon": "pen-tool",      "kind": "whiteboard",  "demoSeed": true },
  { "key": "systemmap","label": "System Map","icon": "workflow",      "kind": "flow",        "demoSeed": true },
  { "key": "scratch",  "label": "Scratch",   "icon": "notebook-pen",  "kind": "spreadsheet", "demoSeed": true },
