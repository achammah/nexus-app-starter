...
License: **MIT, PUBLIC** since 2026-07-19 (see the Publication note below; the earlier private-first posture is superseded). Every file carries an origin tag; `derived` files may not ship to clients or publish until replaced by `rebuilt`.
...
**Publication (2026-07-19):** licensed MIT and made PUBLIC on the user's decision — provenance verified publication-clean at flip time (all files ours/rebuilt; vendored nexus-ui carries its own MIT notices).
